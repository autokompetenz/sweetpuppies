  ...
  fr: [
    {
      ...
      content: `Sweet Puppies — Élevage familial
Rue de l'Orneau 30, 6687 Bastogne, Belgique
TVA : BE0800.443.307
Agrément élevage n° BE0800.443.307
Registre BCE : 0800.443.307

Dirigeants : Aurélie Servais et Emmanuel Fraselle
Forme juridique : Société à responsabilité limitée (SRL)
Activité NACEBEL : 01.480 (Élevage d'autres animaux), 47.762 (Commerce de détail d'animaux domestiques)

Contact : contact@sweetpuppies.be — +32 471 23 45 67
Hébergeur : Vercel Inc., 340 S Lemon Ave #4133, Walnut, CA 91789, USA`,
      ...
      sections: [
        {
          ...
          text: 'Le responsable du traitement des données est Sweet Puppies SRL, Rue de l\'Orneau 30, 6687 Bastogne, Belgique. Pour toute question concernant vos données, contactez-nous à contact@sweetpuppies.be.',
        },
        {
        ...
        },
        {
          ...
          text: 'Vos données ne sont jamais cédées à des tiers. Elles sont accessibles uniquement à l\'équipe de Sweet Puppies. Les données de paiement sont traitées via notre prestataire bancaire sécurisé.',
        },
        {
    ...
    },
    {
      ...
      sections: [
        {
          sub: '1. Objet',
          text: 'Les présentes CGV régissent la réservation et l\'achat de chiots auprès de Sweet Puppies SRL, élevage familial situé à Bastogne, Belgique. Elles s\'appliquent à toute réservation effectuée via le site sweetpuppies.be.',
        },
        {
          sub: '2. Réservation',
          text: 'La réservation est effectuée via le formulaire en ligne. Elle est confirmée après validation par Sweet Puppies et paiement d\'un acompte de 30% du prix du chiot. Le numéro de réservation unique est communiqué par email et permet le suivi en ligne.',
        },
        {
        ...
        },
        {
          ...
          text: 'Tout acompte versé reste acquis à Sweet Puppies en cas d\'annulation par le client, à quelque stade que ce soit. Cette clause couvre les frais de gestion, de vaccination, de vermifugation et de soins déjà engagés.',
        },
        {
          sub: '6. Annulation par l\'élevage',
          text: 'Sweet Puppies se réserve le droit d\'annuler une réservation en cas de : problème de santé vétérinaire du chiot, décès du chiot, ou non-conformité avant le départ. Dans ces seuls cas, l\'acompte est intégralement remboursé.',
        },
        {
          sub: '7. Remise du chiot',
          text: 'Le chiot est remis à partir de l\'âge de 8 semaines révolues, conformément à la législation belge sur la protection animale (loi du 14 août 1986). La remise a lieu de préférence sur place à Bastogne. Un carnet de santé, les vaccins à jour, la puce électronique et le certificat de bonne santé vétérinaire sont fournis.',
        },
        {
          sub: '8. Santé et garantie',
          text: 'Sweet Puppies garantit que le chiot est en bonne santé au moment de la remise, vacciné, vermifugé et identifié par puce électronique. Un certificat vétérinaire est remis. Aucune garantie n\'est donnée quant aux maladies non décelables au moment de la vente (période d\'incubation). L\'acquéreur s\'engage à faire examiner le chiot par un vétérinaire dans les 7 jours suivant la remise.',
        },
        {
          sub: '9. Transport',
          text: 'Le transport du chiot est sous l\'entière responsabilité de l\'acquéreur. Sweet Puppies peut recommander un transporteur agréé mais décline toute responsabilité en cas de problème pendant le transport.',
        },
        {
          sub: '10. Litiges',
  ...
  nl: [
    {
      ...
      content: `Sweet Puppies — Familiale fokkerij
Rue de l'Orneau 30, 6687 Bastogne, België
BTW : BE0800.443.307
Fokkerijvergunning nr. BE0800.443.307
KBO-register : 0800.443.307

Bestuurders : Aurélie Servais en Emmanuel Fraselle
Rechtsvorm : Besloten vennootschap (BV)
NACEBEL-activiteit : 01.480 (Fokken van andere dieren), 47.762 (Detailhandel in huisdieren, benodigdheden)
...
Hosting : Vercel Inc., 340 S Lemon Ave #4133, Walnut, CA 91789, VS`,
    },
    {
      ...
      sections: [
        { sub: '1. Verwerkingsverantwoordelijke', text: 'De verwerkingsverantwoordelijke is Sweet Puppies BV, Rue de l\'Orneau 30, 6687 Bastogne, België. Neem contact met ons op via contact@sweetpuppies.be voor vragen over uw gegevens.' },
        ...
        { sub: '6. Ontvangers van gegevens', text: 'Uw gegevens worden nooit aan derden verstrekt. Ze zijn alleen toegankelijk voor het Sweet Puppies-team. Betalingsgegevens worden verwerkt via onze beveiligde bankpartner.' },
    ...
    },
    {
      ...
      sections: [
        { sub: '1. Toepasselijkheid', text: 'Deze voorwaarden regelen de reservering en aankoop van puppy\'s bij Sweet Puppies BV, een familiale fokkerij in Bastogne, België. Ze zijn van toepassing op elke reservering via sweetpuppies.be.' },
        { sub: '2. Reservering', text: 'De reservering wordt gemaakt via het online formulier. Ze wordt bevestigd na goedkeuring door Sweet Puppies en betaling van een aanbetaling van 30% van de prijs van de puppy. Het unieke reserveringsnummer wordt per e-mail verstrekt voor online opvolging.' },
        ...
        { sub: '5. Annulering door klant', text: 'Eventuele aanbetalingen blijven eigendom van Sweet Puppies bij annulering door de klant, in elk stadium. Deze clausule dekt de kosten van beheer, vaccinatie, ontworming en reeds gemaakte zorgkosten.' },
        { sub: '6. Annulering door fokker', text: 'Sweet Puppies behoudt zich het recht voor een reservering te annuleren bij: veterinair gezondheidsprobleem van de puppy, overlijden van de puppy, of non-conformiteit voor vertrek. In deze gevallen wordt de aanbetaling volledig terugbetaald.' },
        { sub: '7. Levering van de puppy', text: 'De puppy wordt geleverd vanaf de leeftijd van 8 weken, overeenkomstig de Belgische dierenwelzijnswetgeving (wet van 14 augustus 1986). Levering vindt bij voorkeur plaats op locatie in Bastogne. Een gezondheidsboekje, up-to-date vaccinaties, microchip en veterinair gezondheidscertificaat worden meegegeven.' },
        { sub: '8. Gezondheid en garantie', text: 'Sweet Puppies garandeert dat de puppy bij levering in goede gezondheid verkeert, gevaccineerd, ontwormd en geïdentificeerd is met een microchip. Een veterinair certificaat wordt overhandigd. Er wordt geen garantie gegeven voor niet-detecteerbare ziekten op het moment van verkoop (incubatieperiode). De koper moet de puppy binnen 7 dagen na levering door een dierenarts laten onderzoeken.' },
        { sub: '9. Vervoer', text: 'Het vervoer van de puppy is volledig de verantwoordelijkheid van de koper. Sweet Puppies kan een erkende vervoerder aanbevelen maar is niet aansprakelijk voor problemen tijdens het vervoer.' },
  ...
  en: [
    {
      ...
      content: `Sweet Puppies — Family Kennel
Rue de l'Orneau 30, 6687 Bastogne, Belgium
VAT : BE0800.443.307
Breeding license n° BE0800.443.307
BCE Register : 0800.443.307

Directors : Aurélie Servais and Emmanuel Fraselle
Legal form : Private Limited Liability Company
NACEBEL activity : 01.480 (Raising of other animals), 47.762 (Retail sale of pets)
...
Hosting : Vercel Inc., 340 S Lemon Ave #4133, Walnut, CA 91789, USA`,
    },
    {
      ...
      sections: [
        { sub: '1. Data Controller', text: 'The data controller is Sweet Puppies SRL, Rue de l\'Orneau 30, 6687 Bastogne, Belgium. For any questions regarding your data, contact us at contact@sweetpuppies.be.' },
        ...
        { sub: '6. Data Recipients', text: 'Your data is never shared with third parties. It is only accessible to the Sweet Puppies team. Payment data is processed through our secure banking partner.' },
    ...
    },
    {
      ...
      sections: [
        { sub: '1. Scope', text: 'These terms govern the reservation and purchase of puppies from Sweet Puppies SRL, a family kennel in Bastogne, Belgium. They apply to any reservation made via sweetpuppies.be.' },
        { sub: '2. Reservation', text: 'Reservations are made via the online form. They are confirmed after validation by Sweet Puppies and payment of a 30% deposit of the puppy price. A unique reservation number is provided by email for online tracking.' },
        ...
        { sub: '5. Cancellation by Client', text: 'Any deposit paid is retained by Sweet Puppies in case of cancellation by the client, at any stage. This clause covers management, vaccination, deworming, and care costs already incurred.' },
        { sub: '6. Cancellation by Kennel', text: 'Sweet Puppies reserves the right to cancel a reservation in case of: veterinary health issue of the puppy, death of the puppy, or non-compliance before departure. In these cases only, the deposit is fully refunded.' },
        { sub: '7. Puppy Handover', text: 'The puppy is handed over at a minimum of 8 weeks of age, in accordance with Belgian animal welfare legislation (law of August 14, 1986). Handover preferably takes place on-site in Bastogne. A health record, up-to-date vaccinations, microchip, and veterinary health certificate are provided.' },
        { sub: '8. Health and Warranty', text: 'Sweet Puppies guarantees the puppy is in good health at handover, vaccinated, dewormed, and identified by microchip. A veterinary certificate is provided. No warranty is given for diseases undetectable at the time of sale (incubation period). The buyer must have the puppy examined by a veterinarian within 7 days of handover.' },
        { sub: '9. Transport', text: 'Puppy transport is entirely the buyer\'s responsibility. Sweet Puppies may recommend an approved transporter but declines any liability for issues during transport.' },
