...
const RESPONSES = {
  fr: {
    ...
    adresse:  "📍 Sweet Puppies\nRue de l'Élevage 12\n6600 Bastogne, Belgique",
    bonjour:  "Bonjour ! Bienvenue chez Sweet Puppies 🐶\n\nComment puis-je vous aider ?\n• Horaires d'ouverture\n• Prendre rendez-vous\n• Tarifs\n• Notre adresse",
  ...
  nl: {
    ...
    adresse:  "📍 Sweet Puppies\nRue de l'Élevage 12\n6600 Bastogne, België",
    bonjour:  "Hallo! Welkom bij Sweet Puppies 🐶\n\nHoe kan ik u helpen?\n• Openingstijden\n• Afspraak maken\n• Prijzen\n• Adres",
  ...
  en: {
    ...
    bonjour:  "Hello! Welcome to Sweet Puppies 🐶\n\nHow can I help you?\n• Opening hours\n• Book appointment\n• Pricing\n• Our address",
